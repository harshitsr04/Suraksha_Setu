...
(async () => {
  try {
    ...
    // Create maps link with zoom level 17 for better detail
    const mapsLink = `https://maps.google.com/?q=${latitude},${longitude}&z=17`;

    const text = `🚨 EMERGENCY ALERT!\n\nSomeone needs immediate help!\n\n📍 Track real-time location: ${mapsLink}\n\n⚠️ Please respond immediately! This is their current location.`;
